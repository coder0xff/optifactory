...
print(
    f"Machines needed: {len([n for n in factory1.network.body if 'Machine_' in str(n)])}"
)
...
print(
    f"Machines needed: {len([n for n in factory2.network.body if 'Machine_' in str(n)])}"
)
